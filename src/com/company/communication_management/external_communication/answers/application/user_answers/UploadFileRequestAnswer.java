...
public class UploadFileRequestAnswer extends Answer {
    ...
    //CONSTRUCTORS
    public UploadFileRequestAnswer(Socket _socket, Answer.status _status, String _transaction_id) {
        super(_socket);
        m_status = _status;
    ...
    public String toString() {
        return "<UploadFileRequestAnswer::{m_status: " + m_status + ", m_transaction_id: " + m_transaction_id + "}>";
    }
}
